export function snake_assets() {
    ...
    this.load.image('Snake:medal_first', require('../assets/snake/ui/end_game/medal_first.png'))
    this.load.image('Snake:medal_second', require('../assets/snake/ui/end_game/medal_second.png'))
    this.load.image('Snake:medal_third', require('../assets/snake/ui/end_game/medal_third.png'))
    this.load.image('Snake:morfit_coin', require('../assets/snake/ui/end_game/dollar_icon.png'))
