...
class GameSelectScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.modalHeader = this.add
            .text(withDPI(187), withDPI(withModalOffset(32)), 'Minigames', {
        ...
        this.snakeGamePrice = this.add
            .image(
                withDPI(42),
                withDPI(withModalOffset(96)),
                'GameSelect:snake_cost'
            )
        ...
        this.snakeThumbnail = this.add
            .image(
                withDPI(48),
                withDPI(withModalOffset(110)),
                'GameSelect:snake_thumbnail'
            )
            .setScale(withDPI(0.2), withDPI(0.2))
            .setOrigin(0, 0)
            .setDepth(41)
        ...
        this.snakeGameTitle = this.add
            .text(withDPI(112), withDPI(withModalOffset(251)), 'Snake', {
                fontFamily: 'Bubblegum Sans',
                fontSize: '24px',
                color: '#ffffff',
                align: 'center',
        ...
        this.startSnakeButton = this.add
            .image(
                withDPI(50),
                withDPI(withModalOffset(286)),
                'GameSelect:start_button'
            )
            .setScale(withDPI(0.2), withDPI(0.2))
            .setOrigin(0, 0)
            .setDepth(42)
        ...
        this.runMorfiRunThumbnail = this.add
            .image(
                withDPI(199),
                withDPI(withModalOffset(110)),
                'GameSelect:runMorfiRun_thumbnail'
            )
            .setScale(withDPI(0.2), withDPI(0.2))
            .setOrigin(0, 0)
            .setDepth(41)
