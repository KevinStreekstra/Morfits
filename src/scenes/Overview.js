...
class OverviewScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.ground2 = this.addImage(0, 0, 'overview:ground2').setOrigin(
            0.5,
            0.42
        )
        ...
        //icons
        this.kleding = this.addImage(0, 0, 'overview:btnKleding')
            .setOrigin(0.5, 0.37)
            .setInteractive()
        ...
        this.games = this.addImage(0, 0, 'overview:btnGames')
            .setOrigin(0.5, 0.37)
            .setInteractive()
        ...
        this.market = this.addImage(0, 0, 'overview:btnMarket')
            .setOrigin(0.5, 0.37)
            .setInteractive()
        ...
        this.inventory = this.addImage(0, 0, 'overview:btnInventory')
            .setOrigin(0.5, 0.37)
            .setInteractive()
        ...
        this.quiz = this.addImage(0, 0, 'overview:btnQuiz')
            .setOrigin(0.5, 0.37)
            .setInteractive()
        ...
        //morfit & plants
        this.morfitWalking = this.addImage(0, 0, 'Character:full')
            .setScale(withDPI(0.2), withDPI(0.2))
            .setOrigin(0.5, 0.58)
        this.grid.placeAtIndex(142, this.morfitWalking)

        this.txtXPbar = this.add
            .text(
                0,
                0,
                `${this.player.xp}/${this._player.getRequiredXP(
                    this._player.getLevel()
                )}`,
                {
                    fontFamily: 'Bubblegum Sans',
                    fontSize: `${Math.round(10 * window.devicePixelRatio)}px`
                }
            )
            .setOrigin(0.5, 0)
        ...
        this.settings = this.addImage(0, 0, 'overview:btnSettings').setOrigin(
            0.7,
            0
        )
        this.grid.placeAtIndex(164, this.settings)

        this.friends = this.addImage(0, 0, 'overview:btnFriends').setOrigin(
            0.7,
            0.6
        )
        ...
        // Healthbars
        // Mental
        this.MentalBar = this.addImage(0, 0, 'overview:MentalBar').setOrigin(
            0.4,
            0
        )
        this.grid.placeAtIndex(17, this.MentalBar)

        this.txtMentalbar = this.add
            .text(0, 0, `${this.player.mentality}/100`, {
                fontFamily: 'Bubblegum Sans',
                fontSize: `${Math.round(16 * window.devicePixelRatio)}px`,
                fill: '#2CD632',
                align: 'center'
        ...
        this.IconMental = this.addImage(0, 0, 'overview:IconMental').setOrigin(
            0.3,
            0.2
        )
        ...
        // Energy
        this.EnergyBar = this.addImage(0, 0, 'overview:EnergyBar').setOrigin(
            0.4,
            0
        )
        this.grid.placeAtIndex(22, this.EnergyBar)

        this.txtEnergybar = this.add
            .text(0, 0, `${this.player.energy}/100`, {
                fontFamily: 'Bubblegum Sans',
                fontSize: `${Math.round(16 * window.devicePixelRatio)}px`,
                fill: '#3192C9',
                align: 'center'
        ...
        this.IconEnergy = this.addImage(0, 0, 'overview:IconEnergy').setOrigin(
            0.3,
            0.2
        )
        ...
        // Power
        this.PowerBar = this.addImage(0, 0, 'overview:PowerBar').setOrigin(
            0.4,
            0
        )
        this.grid.placeAtIndex(27, this.PowerBar)

        this.txtPowerbar = this.add
            .text(0, 0, `${this.player.power}/100`, {
                fontFamily: 'Bubblegum Sans',
                fontSize: `${Math.round(16 * window.devicePixelRatio)}px`,
                fill: '#FF6565',
                align: 'center'
        ...
        this.IconPower = this.addImage(0, 0, 'overview:IconPower').setOrigin(
            0.3,
            0.2
        )
