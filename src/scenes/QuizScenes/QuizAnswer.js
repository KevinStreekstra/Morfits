...
class QuizAnswer extends Phaser.Scene {
    ...
    create() {
        ...
        this.txt1 = this.add.text(0, 0, 'Vraag 1',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(20 * window.devicePixelRatio)}px`, wordWrap: {width: (300 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.7, 1.4);
        this.grid.placeAtIndex(48, this.txt1);

        this.txt1 = this.add.text(0, 0, 'Wat kan je beter niet teveel eten van de schijf van 5?',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(16 * window.devicePixelRatio)}px`, wordWrap: {width: (200 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.07, 0.2);
        ...
        this.txt1 = this.add.text(0, 0, 'Vraag 2',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(20 * window.devicePixelRatio)}px`, wordWrap: {width: (300 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.7, 1.4);
        this.grid.placeAtIndex(78, this.txt1);

        this.txt1 = this.add.text(0, 0, 'Wat kan de meester/ juffrouw beter niet teveel doen?',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(16 * window.devicePixelRatio)}px`, wordWrap: {width: (200 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.09, 0.2);
        ...
        this.txt1 = this.add.text(0, 0, 'Vraag 3',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(20 * window.devicePixelRatio)}px`, wordWrap: {width: (300 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.7, 1.4);
        this.grid.placeAtIndex(108, this.txt1);

        this.txt1 = this.add.text(0, 0, 'Ik kan beter witbrood eten dan volkorenbrood?',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(16 * window.devicePixelRatio)}px`, wordWrap: {width: (200 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.1, 0.2);
        ...
        this.txt1 = this.add.text(0, 0, 'Vraag 4',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(20 * window.devicePixelRatio)}px`, wordWrap: {width: (300 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.7, 1.4);
        this.grid.placeAtIndex(138, this.txt1);

        this.txt1 = this.add.text(0, 0, 'Welk toetje kan ik het beste eten?',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(16 * window.devicePixelRatio)}px`, wordWrap: {width: (200 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.09, 0.2);
        ...
        this.txt1 = this.add.text(0, 0, 'Vraag 5',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(20 * window.devicePixelRatio)}px`, wordWrap: {width: (300 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.7, 1.4);
        this.grid.placeAtIndex(168, this.txt1);

        this.txt1 = this.add.text(0, 0, 'Wat is waar?',
        { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(16 * window.devicePixelRatio)}px`, wordWrap: {width: (200 * window.devicePixelRatio), useAdvancedWrap: true}}).setOrigin(0.2, 0.2);
