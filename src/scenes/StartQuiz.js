...
class StartQuiz extends Phaser.Scene {
    ...
    create() {
        ...
        this.txt1 = this.add.text(0, 0, 'Ben je er klaar voor?', { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(16 * window.devicePixelRatio)}px`,}).setOrigin(0.5, 1.8).setAngle(3, 1);
