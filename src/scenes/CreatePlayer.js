...
class CreatePlayerScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.bg = this.addRectangle(0, 0, 375, this.sys.game.config.height, 0x132B4B).setOrigin(0, 0);

        this.title = this.add.text(0, 0, 'Vul hier je naam in!', { fontFamily: 'Bubblegum Sans', fontSize: `${Math.round(38 * window.devicePixelRatio)}px`, fill: '#2E3A4B', stroke: '#fff', strokeThickness: 8,}).setOrigin(0.5, 0.5);
        ...
        this.submit = this.addElement(0, 0, "button").setText('Klaar').setOrigin(.5, .5);
