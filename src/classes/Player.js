class Player {
    ...
    init(username) {
        ...
        if (
            ...
            localStorage.getItem('energy') === null
        )
        ...
        if (
            !localStorage.getItem('mentality') ||
            localStorage.getItem('mentality') === null
        )
        ...
        if (
            !localStorage.getItem('powerpoints') ||
            localStorage.getItem('powerpoints') === null
        )
            localStorage.setItem('powerpoints', JSON.stringify(0))

        if (
            !localStorage.getItem('morfos') ||
            localStorage.getItem('morfos') === null
        )
